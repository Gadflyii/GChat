...
pub fn run() {
    ...
    let app_builder = app_builder.invoke_handler(tauri::generate_handler![
        ...
        core::agent::commands::agent_list_model_instances,
        core::agent::studio::agent_studio,
        core::agent::memory::memory_library,
        core::agent::definitions::agent_list_definitions,
        core::agent::definitions::agent_new_definition,
        core::agent::definitions::agent_get_definition,
        core::agent::definitions::agent_save_definition,
