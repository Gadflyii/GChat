...
export type GChatBrowserExtensionDialogState =
  | 'closed'
  | 'checking'
  | 'not_installed'

interface GChatBrowserExtensionDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  state: GChatBrowserExtensionDialogState
  onCancel?: () => void
}

export default function GChatBrowserExtensionDialog({
  open,
  onOpenChange,
  state,
  onCancel,
}: GChatBrowserExtensionDialogProps) {
