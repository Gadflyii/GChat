/**
 * Script to find missing translations in locale files for GChat
 *
 * Usage:
...
if (args.help) {
  console.log(`
Find Missing Translations for GChat
...
function findMissingTranslations() {
  try {
    console.log('Starting translation check for GChat web-app...')
